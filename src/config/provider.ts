import { GOOGLE1_DEFAULT_PROPS } from "../libs/provider/Google1";
import { GOOGLE2_DEFAULT_PROPS } from "../libs/provider/Google2";
import { MICROSOFT_DEFAULT_PROPS } from "../libs/provider/Microsoft";
...
export const OPT_ALL_PROVIDER_PRESET = [
  ...
  GOOGLE2_DEFAULT_PROPS,
  MICROSOFT_DEFAULT_PROPS,
